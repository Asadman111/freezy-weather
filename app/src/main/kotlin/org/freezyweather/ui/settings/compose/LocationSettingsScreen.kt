...
import org.freezyweather.common.extensions.openApplicationDetailsSettings
...
import org.freezyweather.ui.settings.preference.composables.EditTextPreferenceViewWithCard
...
import org.freezyweather.ui.settings.preference.composables.SectionFooter
import org.freezyweather.ui.settings.preference.composables.SectionHeader
import org.freezyweather.ui.settings.preference.editTextPreferenceItem
                    ...
                    Material3ExpressiveCardListItem(
                        ...
                        Column(
                            ...
                            if (BuildConfig.INSTALL_INSTRUCTIONS_LINK.startsWith("https://") &&
                                (
                                    !BuildConfig.INSTALL_INSTRUCTIONS_LINK.contains("freezy", ignoreCase = true) ||
                                        FreezyWeather.instance.isSignedByFreezy ||
                                        FreezyWeather.instance.debugMode
                                    )
                            ) {
                                TextButton(
