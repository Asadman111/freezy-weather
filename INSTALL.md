...
Go to [Releases page](https://github.com/freezy-weather/freezy-weather/releases) and download the file with the following format `freezy-weather-vX.Y.Z_standard.apk`.
...
The recommended flavor of **Freezy Weather** is the standard version. It is fully open source and contains no proprietary components.
...
- Google Play Store:
  ...
  - We don’t [comply with Google Play policy](https://github.com/freezy-weather/freezy-weather/issues/31)
...
1. Add the following URL: `https://github.com/freezy-weather/freezy-weather`
...
In the “Add App” screen, just add as App Source URL the following URL depending on the repository you want to use:
   - Standard flavor from Izzy repo: `https://apt.izzysoft.de/fdroid/index/apk/org.freezyweather`
   - Standard flavor from Freezy Weather repo: configure Obtainium to use GitHub releases instead (see previous section)
   - Free-net flavor from Freezy Weather repo: configure Obtainium to use GitHub releases instead (see previous section)
   - Free-net flavor from default F-Droid repo: `https://f-droid.org/packages/org.freezyweather/`
...
1) Look for the Repositories option from your F-Droid client and add a new repository depending on the source you want to use:
   ...
   - Standard flavor from Freezy Weather repo: `https://freezy-weather.github.io/fdroid-repo/fdroid/repo`
   - Free-net flavor from Freezy Weather repo: `https://freezy-weather.github.io/fdroid-repo/fdroid-version/fdroid/repo`
