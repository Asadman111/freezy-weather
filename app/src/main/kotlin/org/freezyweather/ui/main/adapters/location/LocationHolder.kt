...
package org.freezyweather.ui.main.adapters.location
...
import org.freezyweather.common.extensions.DEFAULT_CARD_LIST_ITEM_ELEVATION_DP
import org.freezyweather.common.extensions.getThemeColor
import org.freezyweather.databinding.ItemLocationCardBinding
...
class LocationHolder(
    ...
    fun onBindView(context: Context, model: LocationModel, resourceProvider: ResourceProvider) {
        val elevatedSurfaceColor = org.freezyweather.common.utils.ColorUtils.getWidgetSurfaceColor(
