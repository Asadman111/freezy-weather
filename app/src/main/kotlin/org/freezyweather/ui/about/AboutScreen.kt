...
package org.freezyweather.ui.about
...
import org.freezyweather.background.updater.interactor.GetApplicationRelease
...
import org.freezyweather.common.extensions.withUIContext
import org.freezyweather.common.utils.helpers.SnackbarHelper
import org.freezyweather.data.appContributors
import org.freezyweather.data.appTranslators
...
import org.freezyweather.ui.common.widgets.getCardListItemMarginDp
import org.freezyweather.ui.common.widgets.insets.FitStatusBarTopAppBar
import org.freezyweather.ui.common.widgets.insets.bottomInsetItem
...
internal fun AboutScreen(
    ...
    val contactLinks = buildList {
        BuildConfig.SOURCE_CODE_LINK.takeIf {
            it.startsWith("https://") &&
                (
                    !BuildConfig.SOURCE_CODE_LINK.contains("freezy", ignoreCase = true) ||
        ...
        BuildConfig.CONTACT_MATRIX.takeIf {
            it.startsWith("https://") &&
                (
                    !BuildConfig.CONTACT_MATRIX.contains("freezy", ignoreCase = true) ||
                        FreezyWeather.instance.isSignedByFreezy ||
                        FreezyWeather.instance.debugMode
                    )
        }?.let {
    ...
    val isUpdateCheckerEnabled = remember {
        FreezyWeather.instance.isGitHubUpdateCheckerEnabled ||
            (
                BuildConfig.RELEASES_LINK.isNotEmpty() &&
                    (
                        !BuildConfig.RELEASES_LINK.contains("freezy", ignoreCase = true) ||
                            FreezyWeather.instance.isSignedByFreezy ||
                            FreezyWeather.instance.debugMode
                        )
                )
