...
package org.freezyweather.sources.knmi
...
import org.freezyweather.sources.knmi.json.KnmiDailyWeatherForecast
import org.freezyweather.sources.knmi.json.KnmiDailyWeatherGraph
import org.freezyweather.sources.knmi.json.KnmiHourlyWeatherForecast
import org.freezyweather.sources.knmi.json.KnmiSunshine
import org.freezyweather.sources.knmi.json.KnmiUvIndex
import org.freezyweather.sources.knmi.json.KnmiWeather
import org.freezyweather.sources.knmi.json.KnmiWeatherAlerts
import org.freezyweather.sources.knmi.json.KnmiWeatherDetail
import org.freezyweather.sources.knmi.json.KnmiWeatherSnapshot
...
class KnmiService @Inject constructor(
    ...
    private var instance: String?
        ...
        get() = config.getString("instance", null)
            ?: if (FreezyWeather.instance.debugMode) KNMI_DEMO_BASE_URL else KNMI_BASE_URL
