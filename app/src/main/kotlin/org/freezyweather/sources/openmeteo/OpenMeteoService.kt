...
package org.freezyweather.sources.openmeteo
...
import org.freezyweather.common.exceptions.LocationSearchException
...
import org.freezyweather.sources.openmeteo.json.OpenMeteoAirQualityHourly
import org.freezyweather.sources.openmeteo.json.OpenMeteoAirQualityResult
import org.freezyweather.sources.openmeteo.json.OpenMeteoLocationResult
import org.freezyweather.sources.openmeteo.json.OpenMeteoWeatherCurrent
import org.freezyweather.sources.openmeteo.json.OpenMeteoWeatherDaily
import org.freezyweather.sources.openmeteo.json.OpenMeteoWeatherHourly
import org.freezyweather.sources.openmeteo.json.OpenMeteoWeatherMinutely
import org.freezyweather.sources.openmeteo.json.OpenMeteoWeatherResult
import org.freezyweather.ui.common.composables.AlertDialogNoPadding
import org.freezyweather.ui.settings.preference.composables.PreferenceView
    ...
    override fun PerLocationPreferences(
        ...
        PreferenceView(
            ...
            summary = weatherModels
                ...
                .joinToString(context.getString(org.freezyweather.unit.R.string.locale_separator)) {
