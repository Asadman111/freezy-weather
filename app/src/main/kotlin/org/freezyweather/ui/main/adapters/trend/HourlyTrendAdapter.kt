...
package org.freezyweather.ui.main.adapters.trend
...
import org.freezyweather.ui.common.widgets.trend.TrendRecyclerView
import org.freezyweather.ui.main.adapters.trend.hourly.AbsHourlyTrendAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyAirQualityAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyCloudCoverAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyFeelsLikeAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyHumidityAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyPrecipitationAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyPressureAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyTemperatureAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyUVAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyVisibilityAdapter
import org.freezyweather.ui.main.adapters.trend.hourly.HourlyWindAdapter
import org.freezyweather.ui.theme.resource.ResourcesProviderFactory

@SuppressLint("NotifyDataSetChanged")
class HourlyTrendAdapter(
    private val activity: FreezyActivity,
