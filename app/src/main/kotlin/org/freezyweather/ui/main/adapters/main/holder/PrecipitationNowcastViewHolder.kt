...
import org.freezyweather.common.extensions.formatMeasureIntensity
...
import org.freezyweather.common.extensions.pxToDp
...
import org.freezyweather.ui.common.charts.SpecificHorizontalAxisItemPlacer
...
private class MarkerLabelFormatterMinutelyDecorator(
    private val mappedValues: Map<Long, org.freezyweather.unit.precipitation.Precipitation>,
