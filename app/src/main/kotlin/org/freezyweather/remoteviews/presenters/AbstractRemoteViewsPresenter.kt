...
package org.freezyweather.remoteviews.presenters
...
import org.freezyweather.common.extensions.formatPercent
import org.freezyweather.common.extensions.getFormattedDate
import org.freezyweather.common.extensions.getFormattedMediumDayAndMonth
import org.freezyweather.common.extensions.getFormattedMediumDayAndMonthInAdditionalCalendar
import org.freezyweather.common.extensions.getFormattedTime
import org.freezyweather.common.extensions.hasPermission
import org.freezyweather.common.extensions.is12Hour
import org.freezyweather.common.options.NotificationTextColor
import org.freezyweather.common.options.WidgetWeekIconMode
import org.freezyweather.common.source.PollenIndexSource
import org.freezyweather.common.utils.ColorUtils
import org.freezyweather.common.utils.helpers.IntentHelper
import org.freezyweather.domain.location.model.getPlace
import org.freezyweather.domain.settings.ConfigStore
import org.freezyweather.domain.weather.model.getDescription
import org.freezyweather.domain.weather.model.getIndex
import org.freezyweather.domain.weather.model.getName
import org.freezyweather.domain.weather.model.getShortDescription
import org.freezyweather.domain.weather.model.getSummary
import org.freezyweather.domain.weather.model.pollensWithConcentration
        ...
        private fun replaceAlerts(
            ...
            currentAlertList.forEach { currentAlert ->
                ...
                currentAlert.startDate?.let { startDate ->
                    ...
                    defaultBuilder.append(context.getString(org.freezyweather.unit.R.string.locale_separator))
                        .append(startDateDay)
                        .append(context.getString(org.freezyweather.unit.R.string.locale_separator))
