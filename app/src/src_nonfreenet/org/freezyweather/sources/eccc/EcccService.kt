...
import org.freezyweather.sources.eccc.json.EcccAlert
import org.freezyweather.sources.eccc.json.EcccDailyFcst
import org.freezyweather.sources.eccc.json.EcccHourly
import org.freezyweather.sources.eccc.json.EcccObservation
import org.freezyweather.sources.eccc.json.EcccRegionalNormalsMetric
import org.freezyweather.sources.eccc.json.EcccResult
import org.freezyweather.sources.eccc.json.EcccUnit
import org.freezyweather.sources.getWindDegree
import org.freezyweather.unit.distance.Distance.Companion.kilometers
import org.freezyweather.unit.pressure.Pressure.Companion.kilopascals
