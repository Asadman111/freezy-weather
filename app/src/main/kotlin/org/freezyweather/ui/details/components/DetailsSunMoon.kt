...
package org.freezyweather.ui.details.components
...
import org.freezyweather.common.extensions.formatTime
...
import org.freezyweather.ui.common.charts.EphemerisChart
import org.freezyweather.ui.common.widgets.Material3ExpressiveCardListItem
import org.freezyweather.ui.common.widgets.astro.MoonPhaseView
import org.freezyweather.ui.common.widgets.defaultCardListItemElevation
import org.freezyweather.ui.theme.weatherView.materialWeatherView.MaterialWeatherThemeDelegate
import org.freezyweather.ui.theme.weatherView.materialWeatherView.implementor.MeteorShowerImplementor
import org.freezyweather.ui.theme.weatherView.materialWeatherView.implementor.SunImplementor
...
fun DailySun(
    ...
    ListItem(
        ...
        headlineContent = {
            Text(
                text = if (FreezyWeather.instance.debugMode) {
                    (
