...
package org.freezyweather.common.activities
...
abstract class FreezyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FreezyWeather.instance.addActivity(this)
    }
    ...
    override fun onPause() {
        super.onPause()
        FreezyWeather.instance.checkToCleanTopActivity(this)
    }

    @CallSuper
    override fun onDestroy() {
        super.onDestroy()
        FreezyWeather.instance.removeActivity(this)
    }
