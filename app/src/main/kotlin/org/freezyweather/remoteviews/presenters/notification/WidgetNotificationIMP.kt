...
package org.freezyweather.remoteviews.presenters.notification
...
import org.freezyweather.common.extensions.getHour
import org.freezyweather.common.extensions.notificationBuilder
import org.freezyweather.common.extensions.notify
...
import org.freezyweather.domain.weather.model.getStrength
import org.freezyweather.domain.weather.model.getTrendFeelsLikeTemperature
import org.freezyweather.domain.weather.model.getTrendTemperature
import org.freezyweather.domain.weather.model.getWeek
import org.freezyweather.domain.weather.model.isToday
import org.freezyweather.remoteviews.Notifications
import org.freezyweather.remoteviews.presenters.AbstractRemoteViewsPresenter
import org.freezyweather.ui.theme.resource.ResourceHelper
...
object WidgetNotificationIMP : AbstractRemoteViewsPresenter() {
    ...
    private fun buildBaseView(
        ...
        if (CalendarHelper.getAlternateCalendarSetting(context) != null) {
            timeStr.append(context.getString(org.freezyweather.unit.R.string.locale_separator))
