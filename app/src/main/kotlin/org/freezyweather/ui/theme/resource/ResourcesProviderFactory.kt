...
package org.freezyweather.ui.theme.resource

import android.content.Context
import org.freezyweather.FreezyWeather
import org.freezyweather.domain.settings.SettingsManager
import org.freezyweather.ui.theme.resource.providers.ChronusResourceProvider
import org.freezyweather.ui.theme.resource.providers.DefaultResourceProvider
import org.freezyweather.ui.theme.resource.providers.IconPackResourcesProvider
...
object ResourcesProviderFactory {
    val newInstance: ResourceProvider
        get() = getNewInstance(SettingsManager.getInstance(FreezyWeather.instance).iconProvider)

    fun getNewInstance(packageName: String?): ResourceProvider {
        val context: Context = FreezyWeather.instance
