...
package org.freezyweather.sources.pirateweather
...
import org.freezyweather.sources.pirateweather.json.PirateWeatherAlert
import org.freezyweather.sources.pirateweather.json.PirateWeatherCurrently
import org.freezyweather.sources.pirateweather.json.PirateWeatherDaily
import org.freezyweather.sources.pirateweather.json.PirateWeatherHourly
import org.freezyweather.sources.pirateweather.json.PirateWeatherMinutely
...
import org.freezyweather.unit.ratio.Ratio.Companion.fraction
...
class PirateWeatherService @Inject constructor(
    ...
    private var instance: String?
        ...
        get() = config.getString("instance", null)
            ?: if (FreezyWeather.instance.debugMode) PIRATE_WEATHER_DEV_BASE_URL else PIRATE_WEATHER_BASE_URL
    ...
    override fun getPreferences(context: Context): List<Preference> {
        return listOf(
            EditTextPreference(
                ...
                content = if (instance != if (FreezyWeather.instance.debugMode) {
                ...
                placeholder = if (FreezyWeather.instance.debugMode) {
                    PIRATE_WEATHER_DEV_BASE_URL
                } else {
                    PIRATE_WEATHER_BASE_URL
                },
                ...
                onValueChanged = {
                    instance = if (it == if (FreezyWeather.instance.debugMode) {
                            PIRATE_WEATHER_DEV_BASE_URL
                        } else {
                            PIRATE_WEATHER_BASE_URL
                        }
