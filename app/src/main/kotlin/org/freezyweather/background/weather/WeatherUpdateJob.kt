...
package org.freezyweather.background.weather
...
import org.freezyweather.background.updater.AppUpdateChecker
import org.freezyweather.common.bus.EventBus
import org.freezyweather.common.extensions.createFileInCacheDir
...
import org.freezyweather.common.extensions.getUriCompat
import org.freezyweather.common.extensions.isOnline
import org.freezyweather.common.extensions.isRunning
import org.freezyweather.common.extensions.setForegroundSafely
import org.freezyweather.common.extensions.withIOContext
import org.freezyweather.common.extensions.workManager
    ...
    private fun writeErrorFile(errors: List<Pair<Location, String?>>): File {
        try {
            if (errors.isNotEmpty()) {
                val file = context.createFileInCacheDir("freezyweather_update_errors.txt")
