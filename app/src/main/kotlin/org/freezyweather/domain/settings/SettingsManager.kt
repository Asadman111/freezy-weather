...
package org.freezyweather.domain.settings
...
import org.freezyweather.common.options.UpdateInterval
...
class SettingsManager private constructor(
    ...
    var updateInterval: UpdateInterval
        ...
        get() = UpdateInterval.getInstance(
            config.getString("refresh_rate", null)
                ?: (if (FreezyWeather.instance.debugMode) "never" else "1:30")
        )
    ...
    var iconProvider: String
        ...
        get() = config.getString("iconProvider", FreezyWeather.instance.packageName) ?: ""
