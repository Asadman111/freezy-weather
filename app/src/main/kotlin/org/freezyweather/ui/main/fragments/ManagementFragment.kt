...
package org.freezyweather.ui.main.fragments
...
import org.freezyweather.common.extensions.isDarkMode
import org.freezyweather.common.extensions.plus
import org.freezyweather.common.extensions.setSystemBarStyle
import org.freezyweather.common.source.getName
import org.freezyweather.common.utils.helpers.IntentHelper
import org.freezyweather.common.utils.helpers.PermissionHelper
import org.freezyweather.common.utils.helpers.SnackbarHelper
import org.freezyweather.domain.location.model.applyDefaultPreset
...
import org.freezyweather.ui.common.composables.NotificationCard
import org.freezyweather.ui.common.composables.SecondarySourcesPreference
import org.freezyweather.ui.common.decorations.Material3ListItemDecoration
import org.freezyweather.ui.common.widgets.Material3ExpressiveCardListItem
import org.freezyweather.ui.common.widgets.Material3Scaffold
import org.freezyweather.ui.common.widgets.defaultCardListItemElevation
import org.freezyweather.ui.common.widgets.insets.BWCenterAlignedTopAppBar
import org.freezyweather.ui.main.MainActivity
import org.freezyweather.ui.main.MainActivityViewModel
import org.freezyweather.ui.main.adapters.location.LocationAdapter
import org.freezyweather.ui.main.widgets.LocationItemTouchCallback
import org.freezyweather.ui.main.widgets.LocationItemTouchCallback.TouchReactor
import org.freezyweather.ui.theme.compose.FreezyWeatherTheme
import org.freezyweather.ui.theme.compose.themeRipple
...
open class ManagementFragment : MainModuleFragment(), TouchReactor {
    ...
    private fun ContentView() {
        ...
        Material3Scaffold(
            ...
            if (validLocationListState.value.isNotEmpty()) {
                Column(
                    ...
                    if (FreezyWeather.instance.isGitHubUpdateCheckerEnabled) {
                        AnimatedVisibilitySlideVertically(
        ...
        if (FreezyWeather.instance.debugMode && dialogChooseDebugLocationOpenState.value) {
            DebugLocationScreen(
                sourceManager = (requireActivity() as MainActivity).sourceManager,
    ...
    private fun initView() {
        ...
        itemTouchHelper = ItemTouchHelper(
            LocationItemTouchCallback(
                requireActivity() as FreezyActivity,
                viewModel,
                this
            )
        )
