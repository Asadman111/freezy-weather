...
package org.freezyweather.common.utils
...
import org.freezyweather.background.receiver.NotificationReceiver
...
import org.freezyweather.common.extensions.withNonCancellableContext
...
class CrashLogUtils(
    ...
    suspend fun dumpLogs() = withNonCancellableContext {
        try {
            val file = context.createFileInCacheDir("freezyweather_crash_logs.txt")
