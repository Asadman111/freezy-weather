...
package org.freezyweather.common.actionmodecallback
...
import org.freezyweather.common.extensions.clipboardManager
import org.freezyweather.common.utils.helpers.SnackbarHelper

internal class FreezyTextToolbar(
    private val view: View,
) : TextToolbar {
    private var actionMode: ActionMode? = null
    private val textActionModeCallback: FreezyTextActionModeCallback =
        FreezyTextActionModeCallback(onActionModeDestroy = { actionMode = null })
    ...
    override fun showMenu(
        ...
        if (actionMode == null) {
            ...
            actionMode = TextToolbarHelperMethods.startActionMode(
                view,
                FreezyFloatingTextActionModeCallback(textActionModeCallback),
