...
package org.freezyweather.sources.nominatim
...
import org.freezyweather.sources.nominatim.json.NominatimAddress
import org.freezyweather.sources.nominatim.json.NominatimLocationResult
...
class NominatimService @Inject constructor(
    ...
    override val isConfigured = BuildConfig.REPORT_ISSUE.isNotEmpty() && FreezyWeather.instance.userAgent.isNotEmpty()
