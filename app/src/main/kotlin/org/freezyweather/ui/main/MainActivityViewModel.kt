...
import org.freezyweather.common.activities.FreezyViewModel
import org.freezyweather.common.activities.livedata.BusLiveData
import org.freezyweather.common.extensions.hasPermission
import org.freezyweather.common.extensions.launchIO
...
import org.freezyweather.domain.location.model.isCloseTo
...
import org.freezyweather.ui.main.utils.StatementManager
...
) : FreezyViewModel(application), WeatherRequestCallback {
