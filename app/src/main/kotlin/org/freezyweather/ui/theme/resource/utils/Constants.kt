...
package org.freezyweather.ui.theme.resource.utils

import freezyweather.domain.weather.reference.WeatherCode

object Constants {
    const val ACTION_ICON_PROVIDER = "org.freezyweather.ICON_PROVIDER"
    const val META_DATA_PROVIDER_CONFIG = "org.freezyweather.PROVIDER_CONFIG"
    const val META_DATA_DRAWABLE_FILTER = "org.freezyweather.DRAWABLE_FILTER"
    const val META_DATA_ANIMATOR_FILTER = "org.freezyweather.ANIMATOR_FILTER"
    const val META_DATA_SHORTCUT_FILTER = "org.freezyweather.SHORTCUT_FILTER"
    const val META_DATA_SUN_MOON_FILTER = "org.freezyweather.SUN_MOON_FILTER"
