...
package org.freezyweather.common.utils.helpers
...
import org.freezyweather.ui.about.AboutActivity
import org.freezyweather.ui.alert.AlertActivity
import org.freezyweather.ui.details.DetailsActivity
import org.freezyweather.ui.main.MainActivity
import org.freezyweather.ui.search.SearchActivity
import org.freezyweather.ui.settings.activities.CardDisplayManageActivity
import org.freezyweather.ui.settings.activities.DailyTrendDisplayManageActivity
import org.freezyweather.ui.settings.activities.DependenciesActivity
import org.freezyweather.ui.settings.activities.HourlyTrendDisplayManageActivity
import org.freezyweather.ui.settings.activities.PreviewIconActivity
import org.freezyweather.ui.settings.activities.PrivacyPolicyActivity
...
object IntentHelper {
    ...
    fun startFreezyActivity(activity: Activity, location: Location) {
        activity.startActivity(
            Intent(
                Intent.ACTION_VIEW,
