...
import org.freezyweather.common.activities.livedata.EqualtableLiveData
import org.freezyweather.common.extensions.density
import org.freezyweather.common.extensions.doOnApplyWindowInsets
import org.freezyweather.common.extensions.getBlocksPerRow
import org.freezyweather.common.extensions.getThemeColor
import org.freezyweather.common.extensions.isDarkMode
import org.freezyweather.common.extensions.isMotionReduced
import org.freezyweather.common.extensions.isTabletDevice
import org.freezyweather.common.extensions.setSystemBarStyle
import org.freezyweather.common.options.appearance.BackgroundAnimationMode
import org.freezyweather.databinding.FragmentHomeBinding
import org.freezyweather.domain.location.model.getPlace
import org.freezyweather.domain.settings.SettingsManager
import org.freezyweather.ui.common.widgets.SwipeSwitchLayout
import org.freezyweather.ui.main.MainActivity
import org.freezyweather.ui.main.MainActivityViewModel
import org.freezyweather.ui.main.adapters.main.MainAdapter
import org.freezyweather.ui.main.adapters.main.ViewType
import org.freezyweather.ui.main.layouts.MainLayoutManager
import org.freezyweather.ui.main.utils.MainModuleUtils
...
class HomeFragment : MainModuleFragment() {
    ...
    private fun updateDarkMode(location: Location?) {
        ...
        (activity as FreezyActivity).updateLocalNightMode(expectedLightTheme)
    }
