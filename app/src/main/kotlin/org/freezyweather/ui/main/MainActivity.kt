...
package org.freezyweather.ui.main
...
import org.freezyweather.Migrations
import org.freezyweather.R
import org.freezyweather.common.activities.FreezyActivity
import org.freezyweather.common.bus.EventBus
import org.freezyweather.common.extensions.conditional
import org.freezyweather.common.extensions.doOnApplyWindowInsets
import org.freezyweather.common.extensions.getThemeColor
import org.freezyweather.common.extensions.hasPermission
import org.freezyweather.common.extensions.isLandscape
import org.freezyweather.common.extensions.isRtl
import org.freezyweather.common.snackbar.SnackbarContainer
...
import org.freezyweather.databinding.ActivityMainBinding
import org.freezyweather.domain.settings.SettingsChangedMessage
import org.freezyweather.sources.SourceManager
import org.freezyweather.ui.common.composables.AlertDialogConfirmOnly
import org.freezyweather.ui.common.composables.AlertDialogNoPadding
import org.freezyweather.ui.common.composables.LocationPreference
import org.freezyweather.ui.main.dialogs.LicenseComplianceDialog
import org.freezyweather.ui.main.fragments.HomeFragment
import org.freezyweather.ui.main.fragments.ManagementFragment
import org.freezyweather.ui.main.fragments.PushedManagementFragment
import org.freezyweather.ui.search.SearchActivity
import org.freezyweather.ui.theme.ThemeManager
import org.freezyweather.ui.theme.compose.FreezyWeatherTheme
import javax.inject.Inject

@AndroidEntryPoint
class MainActivity : FreezyActivity(), HomeFragment.Callback, ManagementFragment.Callback {
    ...
    private val openSearchActivity =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
            if (it.resultCode == RESULT_OK && it.data != null) {
                FreezyWeather.instance.setTopActivity(this)
    ...
    override fun onStart() {
        ...
        if (FreezyWeather.instance.isImpersonatingFreezyWeather) {
    ...
    override fun onOpenInOtherAppIconClicked() {
        viewModel.currentLocation.value?.location?.let {
            try {
                IntentHelper.startFreezyActivity(this@MainActivity, it)
