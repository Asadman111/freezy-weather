...
package org.freezyweather.ui.main.adapters.trend.daily
...
import org.freezyweather.ui.common.widgets.trend.chart.PolylineAndHistogramView
...
class DailyTemperatureAdapter(
    ...
    inner class ViewHolder(itemView: View) : AbsDailyTrendAdapter.ViewHolder(itemView) {
        ...
        fun onBindView(activity: FreezyActivity, location: Location, position: Int) {
            ...
            daily.day?.let { day ->
                talkBackBuilder.append(activity.getString(org.freezyweather.unit.R.string.locale_separator))
                ...
                day.temperature?.temperature?.let {
                    talkBackBuilder.append(it.formatMeasure(activity, temperatureUnit, unitWidth = UnitWidth.LONG))
                        .append(activity.getString(org.freezyweather.unit.R.string.locale_separator))
                }
