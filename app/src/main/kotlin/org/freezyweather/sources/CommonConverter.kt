...
import freezyweather.domain.weather.model.Astro
import freezyweather.domain.weather.model.Current
import freezyweather.domain.weather.model.Daily
import freezyweather.domain.weather.model.DailyCloudCover
import freezyweather.domain.weather.model.DailyDewPoint
import freezyweather.domain.weather.model.DailyPressure
import freezyweather.domain.weather.model.DailyRelativeHumidity
import freezyweather.domain.weather.model.DailyVisibility
...
import freezyweather.domain.weather.model.MoonPhase
...
import org.freezyweather.common.extensions.CLOUD_COVER_BKN
import org.freezyweather.common.extensions.CLOUD_COVER_FEW
import org.freezyweather.common.extensions.ensurePositive
...
import org.freezyweather.domain.weather.model.validate
import org.freezyweather.ui.theme.weatherView.WeatherViewController
import org.freezyweather.unit.computing.computeApparentTemperature
import org.freezyweather.unit.computing.computeDewPoint
import org.freezyweather.unit.computing.computeHumidex
import org.freezyweather.unit.computing.computeRelativeHumidity
import org.freezyweather.unit.computing.computeTotalPrecipitation
import org.freezyweather.unit.computing.computeTotalProbabilityOfPrecipitation
import org.freezyweather.unit.computing.computeWindChillTemperature
import org.freezyweather.unit.distance.Distance
import org.freezyweather.unit.distance.Distance.Companion.meters
import org.freezyweather.unit.duration.toValidDailyOrNull
import org.freezyweather.unit.duration.toValidHalfDayOrNull
import org.freezyweather.unit.pollutant.PollutantConcentration.Companion.microgramsPerCubicMeter
import org.freezyweather.unit.precipitation.Precipitation.Companion.micrometers
...
import org.freezyweather.unit.pressure.Pressure.Companion.pascals
import org.freezyweather.unit.ratio.Ratio
import org.freezyweather.unit.ratio.Ratio.Companion.percent
import org.freezyweather.unit.ratio.Ratio.Companion.permille
...
import org.freezyweather.unit.temperature.Temperature.Companion.deciCelsius
...
private fun completeHalfDayFromHourlyList(
    ...
    val initialTemperature = freezyweather.domain.weather.model.Temperature(
...
private fun getHalfDayTemperatureFromHourlyList(
    initialTemperature: freezyweather.domain.weather.model.Temperature?,
    halfDayHourlyList: List<Hourly>,
    isDay: Boolean,
): freezyweather.domain.weather.model.Temperature {
    val newTemperature = initialTemperature ?: freezyweather.domain.weather.model.Temperature()
...
private fun completeCurrentTemperatureFromHourly(
    ...
    hourlyTemperature: freezyweather.domain.weather.model.Temperature?,
    windSpeed: Speed?,
    ...
    return freezyweather.domain.weather.model.Temperature(
