...
package org.freezyweather.common.di
...
import freezyweather.data.AlertSeverityColumnAdapter
import freezyweather.data.Alerts
import freezyweather.data.AndroidDatabaseHandler
import freezyweather.data.Dailys
import freezyweather.data.Database
import freezyweather.data.DatabaseHandler
import freezyweather.data.DistanceColumnAdapter
import freezyweather.data.DurationColumnAdapter
import freezyweather.data.Hourlys
import freezyweather.data.Locations
import freezyweather.data.Minutelys
import freezyweather.data.Normals
import freezyweather.data.PollenConcentrationColumnAdapter
import freezyweather.data.PollutantConcentrationColumnAdapter
import freezyweather.data.PrecipitationColumnAdapter
import freezyweather.data.PressureColumnAdapter
import freezyweather.data.RatioColumnAdapter
import freezyweather.data.SpeedColumnAdapter
import freezyweather.data.TemperatureColumnAdapter
import freezyweather.data.TimeZoneColumnAdapter
import freezyweather.data.WeatherCodeColumnAdapter
import freezyweather.data.Weathers
