...
package org.freezyweather.ui.main.dialogs
                        ...
                        text = {
                            Column(
                                ...
                                if (BuildConfig.IS_FREEZY) {
                                    ...
                                    DialogListItem(
                                        ...
                                        icon = if (activity.getString(R.string.brand_name)
                                                .contains("freezy", ignoreCase = true)
                                        ) {
                                            "❌"
                                        } else {
                                            "✅"
                                ...
                                DialogListItem(
                                    ...
                                    icon = if (BuildConfig.APPLICATION_ID.contains("freezy", ignoreCase = true)) {
                                        "❌"
                                    } else {
                                        "✅"
                                    }
