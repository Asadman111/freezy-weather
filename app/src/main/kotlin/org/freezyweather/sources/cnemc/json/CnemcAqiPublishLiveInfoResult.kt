...
@Serializable
data class CnemcAqiPublishLiveInfoResult(
    val so2: String? = null,
    val so2IAQI: String? = null,
    val no2: String? = null,
    val no2IAQI: String? = null,
    val pm10: String? = null,
    val pm10IAQI: String? = null,
    val co: String? = null,
    val coIAQI: String? = null,
    val o3: String? = null,
    val o3IAQI: String? = null,
    val pm25: String? = null,
    val pm25IAQI: String? = null,
    val aqi: String? = null,
