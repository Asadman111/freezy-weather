...
package org.freezyweather.ui.theme.resource.providers
...
import org.freezyweather.ui.common.images.MoonDrawable
import org.freezyweather.ui.common.images.SunDrawable
import org.freezyweather.ui.theme.resource.utils.Constants
import org.freezyweather.ui.theme.resource.utils.XmlHelper
...
class DefaultResourceProvider : ResourceProvider() {
    ...
    init {
        mContext = FreezyWeather.instance
    ...
    companion object {
        fun isDefaultIconProvider(packageName: String): Boolean {
            return packageName == FreezyWeather.instance.packageName
        }
