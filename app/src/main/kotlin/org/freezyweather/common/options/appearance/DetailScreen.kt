...
package org.freezyweather.common.options.appearance
...
import org.freezyweather.common.options.BaseEnum
...
enum class DetailScreen(
    ...
    companion object {
        ...
        fun getSummary(context: Context, list: List<DetailScreen>): String {
            ...
            return builder.toString().replace(",", context.getString(org.freezyweather.unit.R.string.locale_separator))
        }
    }
