...
package org.freezyweather.sources.accu
...
import freezyweather.domain.location.model.LocationAddressInfo
...
import freezyweather.domain.weather.model.DegreeDay
...
import freezyweather.domain.weather.reference.AlertSeverity
...
import freezyweather.domain.weather.wrappers.CurrentWrapper
import freezyweather.domain.weather.wrappers.DailyWrapper
import freezyweather.domain.weather.wrappers.HalfDayWrapper
import freezyweather.domain.weather.wrappers.HourlyWrapper
import freezyweather.domain.weather.wrappers.PollenWrapper
...
import org.freezyweather.common.exceptions.InvalidLocationException
import org.freezyweather.common.extensions.code
import org.freezyweather.common.extensions.codeWithCountry
import org.freezyweather.common.extensions.currentLocale
import org.freezyweather.common.extensions.toCalendarWithTimeZone
import org.freezyweather.common.extensions.toDate
import org.freezyweather.common.extensions.toTimezoneSpecificHour
import org.freezyweather.common.preference.EditTextPreference
import org.freezyweather.common.preference.ListPreference
import org.freezyweather.common.preference.Preference
import org.freezyweather.domain.settings.SettingsManager
import org.freezyweather.domain.settings.SourceConfigStore
import org.freezyweather.sources.accu.json.AccuAirQualityData
import org.freezyweather.sources.accu.json.AccuAirQualityResult
import org.freezyweather.sources.accu.json.AccuAlertResult
import org.freezyweather.sources.accu.json.AccuClimoSummaryResult
import org.freezyweather.sources.accu.json.AccuCurrentResult
import org.freezyweather.sources.accu.json.AccuForecastAirAndPollen
import org.freezyweather.sources.accu.json.AccuForecastDailyForecast
import org.freezyweather.sources.accu.json.AccuForecastDailyResult
import org.freezyweather.sources.accu.json.AccuForecastHourlyResult
import org.freezyweather.sources.accu.json.AccuLocationResult
import org.freezyweather.sources.accu.json.AccuMinutelyResult
import org.freezyweather.sources.accu.json.AccuValue
import org.freezyweather.sources.accu.preferences.AccuDaysPreference
import org.freezyweather.sources.accu.preferences.AccuHoursPreference
import org.freezyweather.sources.accu.preferences.AccuPortalPreference
import org.freezyweather.unit.distance.Distance
import org.freezyweather.unit.distance.Distance.Companion.feet
import org.freezyweather.unit.distance.Distance.Companion.kilometers
import org.freezyweather.unit.distance.Distance.Companion.meters
import org.freezyweather.unit.distance.Distance.Companion.miles
import org.freezyweather.unit.pollen.PollenConcentration.Companion.perCubicMeter
import org.freezyweather.unit.pollutant.PollutantConcentration
import org.freezyweather.unit.pollutant.PollutantConcentration.Companion.microgramsPerCubicMeter
import org.freezyweather.unit.precipitation.Precipitation.Companion.centimeters
import org.freezyweather.unit.precipitation.Precipitation.Companion.inches
...
import org.freezyweather.unit.speed.Speed.Companion.kilometersPerHour
import org.freezyweather.unit.speed.Speed.Companion.milesPerHour
...
import org.freezyweather.unit.temperature.Temperature.Companion.fahrenheit
...
class AccuService @Inject constructor(
    ...
    private fun getQuantity(value: AccuValue?): org.freezyweather.unit.precipitation.Precipitation? {
        return when (value?.UnitType) {
